...
export const strings = {
  en: {
    ...
    teach_join_waitlist_hint: 'Join the waitlist below to be notified when this course opens.',
  ...
  fr: {
    ...
    teach_join_waitlist_hint: 'Inscrivez-vous à la liste d\'attente ci-dessous pour être prévenu à l\'ouverture du cours.',
    contact_kicker: 'Contact',
