  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h1 className="font-display text-2xl font-bold text-[var(--white)]">Timeline (CV)</h1>
        <Button onClick={openCreate} className="bg-[var(--sungold)] text-[var(--void)] font-display font-semibold">Add entry</Button>
      </div>
