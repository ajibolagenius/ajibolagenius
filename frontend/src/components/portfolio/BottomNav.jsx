...
const BottomNav = () => {
  ...
  return (
    <>
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 md:hidden flex justify-around items-center h-16 bg-[var(--nav-mobile-bg)] backdrop-blur-[20px] border-t border-[var(--border)] pb-safe shadow-[0_-4px_0_rgba(0,0,0,0.4)]">
        {navItems.map((item) => {
