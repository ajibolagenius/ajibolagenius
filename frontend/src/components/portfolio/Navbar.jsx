...
const Navbar = () => {
    ...
    return (
        <nav
            className="fixed top-0 left-0 right-0 z-50 h-14 flex items-center justify-between transition-all duration-300 border-b border-[var(--border)] backdrop-blur-[20px] px-4 md:px-8"
            style={{
        ...
        >
            ...
            {/* Mobile menu */}
            {mobileOpen && (
                <div className="md:hidden absolute top-14 left-0 right-0 py-6 px-4 md:px-8 bg-[rgba(7,7,15,0.97)] backdrop-blur-[20px] border-b border-[var(--border)]">
